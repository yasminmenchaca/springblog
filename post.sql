...
insert into posts (title, body)
values ('ultrices phasellus id sapien', 'nisi venenatis tristique fusce congue diam id ornare imperdiet sapien');
insert into posts (title, body)
values ('etiam justo etiam', 'hac habitasse platea dictumst etiam faucibus cursus urna ut tellus nulla ut');
insert into posts (title, body)
values ('vitae ipsum aliquam non',
        'eu magna vulputate luctus cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus vivamus');
insert into posts (title, body)
values ('libero ut massa volutpat',
        'pede ac diam cras pellentesque volutpat dui maecenas tristique est et tempus semper est quam pharetra');
insert into posts (title, body)
values ('magna bibendum imperdiet nullam',
        'aliquet ultrices erat tortor sollicitudin mi sit amet lobortis sapien sapien non mi integer ac neque duis bibendum morbi');
insert into posts (title, body)
values ('in purus eu magna', 'vel accumsan tellus nisi eu orci mauris lacinia sapien quis libero nullam sit amet');
insert into posts (title, body)
values ('proin at turpis a',
